...
type ThunkPeopleType = ThunkAction<Promise<void>, AllStateType, any, PeopleAction>;

export const getUsers = (page = 1): ThunkPeopleType => {
...
export const changeFollowed = (user: any): ThunkPeopleType => {
    return async (dispatch) => {
